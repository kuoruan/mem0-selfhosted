    ...
    if method == "tools/call":
        ...
        if params.get("name") != TOOL_NAME:
            ...
            try:
                ...
                # Configuration errors from the URL resolvers are actionable, so
                # surface them instead of the generic failure text.
                result = _tool_response(f"Memory search failed: {exc}", is_error=True)
            except Exception:
